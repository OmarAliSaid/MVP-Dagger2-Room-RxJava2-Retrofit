...
public class SharedPreferenceUtils implements PreferenceHelper{
    ...
    @Inject
    public SharedPreferenceUtils(@ApplicationContext Context context) {
    ...
    public void setCurrentUserID(int userID) {
        setValue(PreferenceKeys.KEY_USER_ID , userID);
    }

    @Override
    public void setUserAsLoggedOut() {
        removeKey(PreferenceKeys.KEY_USER_OBJECT);
    }

    @Override
    public int getUserID() {
        return getIntValue(PreferenceKeys.KEY_USER_ID , 0);
    }
}
